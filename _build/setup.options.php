...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install LoginAs</h2>

        <p>Thanks for installing LoginAs. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade LoginAs</h2>

        <p>LoginAs will be upgraded. This open source extra was developed by
