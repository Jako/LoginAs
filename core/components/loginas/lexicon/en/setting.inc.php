<?php
/**
 * Setting Lexicon Entries for LoginAs
 *
 * @package loginas
 * @subpackage lexicon
 */
...
$_lang['setting_loginas.login_context_desc'] = 'Main context for frontend authentication.';
$_lang['setting_loginas.login_id'] = 'Login ID';
$_lang['setting_loginas.login_id_desc'] = 'ID of a MODX resource where the login is redirected to in the MODX menu entry.';
